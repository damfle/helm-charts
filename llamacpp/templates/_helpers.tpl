...
{{- default "llamacpp" .Values.nameOverride | trunc 63 | trimSuffix "-" }}
{{- end }}

{{/*
Create a default fully qualified app name for llamacpp.
...
{{- else }}
{{- $name := default "llamacpp" .Values.nameOverride }}
