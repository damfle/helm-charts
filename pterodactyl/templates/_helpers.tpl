...
{{- default "pterodactyl" .Values.nameOverride | trunc 63 | trimSuffix "-" }}
{{- end }}

{{/*
Create a default fully qualified app name for Pterodactyl.
...
{{- else }}
{{- $name := default "pterodactyl" .Values.nameOverride }}
...
{{/*
Selector labels for Pterodactyl
*/}}
