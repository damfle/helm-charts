...
*/}}
{{- define "jupyter.name" -}}
{{- default "jupyter" .Values.nameOverride | trunc 63 | trimSuffix "-" }}
{{- end }}

{{/*
Create a default fully qualified app name for jupyter.
...
{{- else }}
{{- $name := default "jupyter" .Values.nameOverride }}
